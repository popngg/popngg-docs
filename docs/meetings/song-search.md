...
Redis는 source of truth가 아닙니다. DB의 `songs`, `charts`, 검색 태그/별칭 데이터를 기반으로 검색 문서를 만들고 Redis에 반영합니다.
...
- Redis에 검색용 read model과 prefix index를 둡니다.
