...
LONG POP ON/OFF 상태는 클리어 메달로 파악할 수 있습니다. LONG POP을 OFF하고 롱 팝 채보를 클리어한 상태는 확정된 코드 12 `LONGOFF_CLEAR`입니다.
...
3. popclass 계산에서 “유지된 최고 score + 최신 medal” 조합을 어떻게 적용할 것인가?
...
- popclass 메달 보너스에서 코드 12는 `LONGOFF_CLEAR` 분류를 적용합니다.
