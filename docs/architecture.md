...
<div class="doc-summary">
  <div class="doc-summary__item">
    <strong>핵심 목표</strong>
    <p>HTTP, DB, Security, 외부 I/O가 domain/application 규칙을 오염시키지 않게 합니다.</p>
  </div>
  <div class="doc-summary__item">
    <strong>모듈 기준</strong>
    <p>`api`, `application`, `domain`, `infra`를 분리하고 의존 방향은 안쪽으로만 향하게 둡니다.</p>
  </div>
  <div class="doc-summary__item">
    <strong>성능 기준</strong>
    <p>긴 갱신, 집계, 이미지 I/O는 request thread에서 분리하고 bounded executor/job으로 처리합니다.</p>
  </div>
</div>

<figure class="doc-image-figure">
  <img src="../assets/images/architecture-overview.png" alt="popn.gg 리팩토링 아키텍처 다이어그램" class="doc-image" />
  <figcaption>Vercel 프론트, Spring Boot 백엔드, 클린/헥사고널 계층, 2대 서버 운영 구성을 요약한 아키텍처 다이어그램입니다.</figcaption>
</figure>
